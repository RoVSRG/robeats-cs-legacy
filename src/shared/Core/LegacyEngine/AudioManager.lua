...
local HitSFXGroup = require(game.ReplicatedStorage.Client.Components.Screens.Gameplay.Engine.HitSFXGroup)
...
local TimingPresets = require(game.ReplicatedStorage.Shared.Core.Data.TimingPresets)
local Configuration = require(game.ReplicatedStorage.Shared.Core.Data.Configuration)

local SingleNote = require(game.ReplicatedStorage.Client.Components.Screens.Gameplay.Engine.NoteTypes.SingleNote)
local HeldNote = require(game.ReplicatedStorage.Client.Components.Screens.Gameplay.Engine.NoteTypes.HeldNote)
