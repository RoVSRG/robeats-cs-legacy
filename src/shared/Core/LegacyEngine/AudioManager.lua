...
local HitSFXGroup = require(game.ReplicatedStorage.Client.Components.Screens.Gameplay.API.HitSFXGroup)
...
local SingleNote = require(game.ReplicatedStorage.Client.Components.Screens.Gameplay.API.NoteTypes.SingleNote)
local HeldNote = require(game.ReplicatedStorage.Client.Components.Screens.Gameplay.API.NoteTypes.HeldNote)
