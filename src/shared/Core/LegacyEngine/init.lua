...
local ScoreManager = require(game.ReplicatedStorage.Client.Components.Screens.Gameplay.Engine.ScoreManager)
local NoteTrackSystem = require(game.ReplicatedStorage.Client.Components.Screens.Gameplay.Engine.NoteTrack.NoteTrackSystem)
...
local ObjectPool = require(game.ReplicatedStorage.Client.Components.Screens.Gameplay.Engine.ObjectPool)
