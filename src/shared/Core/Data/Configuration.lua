...
local Configuration = {
		Preferences = SPUtil:copy_table(require(game.ReplicatedStorage.Shared.Core.Data.DefaultSettings));
		SessionSettings = SPUtil:copy_table(require(game.ReplicatedStorage.Shared.Core.Data.SessionSettings));
}
