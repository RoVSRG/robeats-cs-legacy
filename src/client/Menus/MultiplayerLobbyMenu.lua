...
local MultiplayerClient = require(game.ReplicatedStorage.Shared.Core.Engine.MultiplayerClient)
...
function MultiplayerLobbyMenu:new(_local_services)
    ...
    local MultiplayerGameMenu = require(game.ReplicatedStorage.Shared.Menus.MultiplayerGameMenu)
